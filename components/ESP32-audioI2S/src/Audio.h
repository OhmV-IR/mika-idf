...
#define ANSI_ESC_WHITE   "\033[37m"
        ...
        if (level == 1 && CONFIG_LOG_DEFAULT_LEVEL >= 1) {
            logStr.append(ANSI_ESC_RED);
        } else if (level == 2 && CONFIG_LOG_DEFAULT_LEVEL >= 2) {
            logStr.append(ANSI_ESC_YELLOW);
        } else if (level == 3 && CONFIG_LOG_DEFAULT_LEVEL >= 3) {
            logStr.append(ANSI_ESC_GREEN);
        } else if (level == 4 && CONFIG_LOG_DEFAULT_LEVEL >= 4) {
            logStr.append(ANSI_ESC_CYAN);
        } // debug
        else if (level == 5 && CONFIG_LOG_DEFAULT_LEVEL >= 4) {
